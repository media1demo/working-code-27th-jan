...
const effects = [
    ...
    'running2',  // 'wave',
    'running3', //'fullimage left side move',
    'running4',
    'running5',
    'running6',
    'running7',
...
// Add an event listener to the animation checkbox
// document.getElementById('animationCheckbox').addEventListener('change', toggleAnimationEffects);
...
//             return result;
//         } catch (error) {
//             console.error(`Error processing ${sourceType} image with ${effect}:`, error);
//             return null;
//         }
//     };
