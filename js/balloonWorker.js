...
function applyWalkingEffect(imageData, selectedRegions, t) {
    ...
    const compressFactor = 1 / (1 + t * 0.1); // Compression factor based on time
    const waveAmplitude = -t * 10; // Inverse wave amplitude
    const waveFrequency = 0.05; // Wave frequency
