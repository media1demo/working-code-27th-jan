...
// Function to apply stretch effect
function applyStretchEffect(imageData, value) {
...
self.onmessage = function(e) {
    ...
    try {
        ...
        // First apply the stretch effect
        let processedImageData = applyStretchEffect(imageData, value);
