...
function moveRegionUpLeft(imageData, totalMove) {
...
function moveSelectedRegionsUpLeft(imageData, selectedRegions, maxVerticalOffset) {
    const width = imageData.width;
    const height = imageData.height;
...
self.onmessage = function(e) {
    ...
    try {
        ...
        if (selectedRegions?.length > 0 && selectedRegions[0]?.length > 0) {
            resultImageData = moveSelectedRegionsUpLeft(imageData, selectedRegions, maxVerticalOffset);
            ...
            moveRegionUpLeft(resultImageData, totalMove);
            currentIteration++;
            progress = undefined;
        }
