...
const DEFAULT_CYCLE_LENGTH = 7; // Number of frames in the spiral cycle
const DEFAULT_SPIRAL_AMPLITUDE = 0.2; // Amplitude of the spiral effect
...
function applySpiralEffect(imageData, selectedRegions, t) {
    ...
    const phase = (t * cycleLength) % 1; // Current phase of the spiral cycle
    const spiralAmplitude = DEFAULT_SPIRAL_AMPLITUDE; // Amplitude of the spiral effect
    ...
    for (let regionIndex = 0; regionIndex < selectedRegions.length; regionIndex++) {
        ...
        // Calculate expanded bounds to allow for spiral
        ...
        const padding = Math.ceil(maxRadius * spiralAmplitude);
        ...
        // Process expanded area for spiral effect
...
self.onmessage = function(e) {
    try {
        const {
            ...
            spiralAmplitude = DEFAULT_SPIRAL_AMPLITUDE
        } = e.data;
...
// Placeholder for yogaleftWorker.js