...
// Helper function to create a transparent ImageData object
...
function expandRegion(selectedRegions, width, height, expansionFactor) {
    ...
    // Add expanded pixels to the set
...
// Function to apply zoom effect on the selected regions
