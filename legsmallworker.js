self.onmessage = function(e) {
    ...
    const processMovements = async () => {
        ...
        for (let index = 0; index < numberOfVariations; index++) {
            const angleConfig = {
                leftUpperLegAngle: generateRandomAngle(0, 40),
                leftLowerLegAngle: generateRandomAngle(0, 40),
                rightUpperLegAngle: generateRandomAngle(0, 40),
                rightLowerLegAngle: generateRandomAngle(0, 40)
            };
